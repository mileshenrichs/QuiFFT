...
public abstract class FFTOutputObject {
     ...
     * This is calculated by dividing the audio file's sampling rate by the number of points in the FFT.
     ...
     * FFT calculations per unit of time (sampling windows are larger).
     */
